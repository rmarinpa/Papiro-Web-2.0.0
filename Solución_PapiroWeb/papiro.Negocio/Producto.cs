    ...
    public class Producto
    {
        ...
        public bool CreateProducto()
        {
            try
            {
                ...
                productos.id_codigos = this.Id_Codigos;
                productos.Codigo = this.Codigo;
                productos.Marca = this.Marca;
                productos.Descripcion = this.Descripcion;
                productos.Tipo_1 = this.Tipo_1;
                productos.medidas = this.Medidas;
                productos.unid_paquete = this.Unid_Paquete;
                productos.ancho = this.Ancho;
                productos.largo = this.Largo;
                productos.area = this.Area;
                productos.descripcion_2 = this.Descripcion_2;
                productos.area_negocio = this.Area_Negocio;
                productos.proveedor = this.Proveedor;
                productos.mapa = this.Mapa;
                productos.descripcion_3 = this.Descripcion_3;
                productos.obs = this.Obs;
                productos.familia = this.Familia;
                productos.familia_2 = this.Familia2;
                productos.familia_3 = this.Familia3;
                productos.stock = this.Stock;
                productos.medida_unid = this.Medida_Unidad;
                productos.Precio_lista = this.Precio_Lista;
                productos.fecha_caducidad = this.Fecha_Caducidad;
                productos.precio_max = this.Precio_Max;
                productos.precio_min = this.Precio_Min;
                productos.activo = this.Activo;
                productos.Categoria = this.Categoria;
                productos.Categoria2 = this.Categoria2; 
